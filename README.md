...
This repo is porting an implementation of PyTorch version YOLOX to Nvidia Jetson Orin, there is also a [MegEngine implementation](https://github.com/MegEngine/YOLOX).
